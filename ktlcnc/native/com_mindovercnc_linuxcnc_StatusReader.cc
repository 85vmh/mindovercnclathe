 ...
 * **************************************************************************
 *
 *  file:       com_mindovercnc_linuxcnc_StatusReader.cc
 ...
 */
JNIEXPORT jobject JNICALL Java_com_mindovercnc_linuxcnc_StatusReader_init(JNIEnv *env
                                                                    , jobject thisObject) {
 ...
 */
JNIEXPORT jstring JNICALL Java_com_mindovercnc_linuxcnc_StatusReader_getString(JNIEnv *env
                                                                         , jobject thisObject
                                                                         , jint offset
                                                                         , jint length) {
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_mindovercnc_linuxcnc_StatusReader_readStatus(JNIEnv *env
                                                                       , jobject thisObject) {
