...
class VarFileRepositoryImpl constructor(
    ...
    private fun parsePositions(builders: ParametersStateBuilder, parsedLine: ParsedLine, firstParamNumber: Int) {
        when (firstParamNumber) {
            ...
            g560.firstParamNumber -> setPositionProperty(builders.coordinateSystems[2], parsedLine, firstParamNumber)
            g570.firstParamNumber -> setPositionProperty(builders.coordinateSystems[3], parsedLine, firstParamNumber)
            g580.firstParamNumber -> setPositionProperty(builders.coordinateSystems[4], parsedLine, firstParamNumber)
            g590.firstParamNumber -> setPositionProperty(builders.coordinateSystems[5], parsedLine, firstParamNumber)
            g591.firstParamNumber -> setPositionProperty(builders.coordinateSystems[6], parsedLine, firstParamNumber)
            g592.firstParamNumber -> setPositionProperty(builders.coordinateSystems[7], parsedLine, firstParamNumber)
            g593.firstParamNumber -> setPositionProperty(builders.coordinateSystems[8], parsedLine, firstParamNumber)
        }
    }

    private fun setPositionProperty(builder: Position.Builder, parsedLine: ParsedLine, firstParamNumber: Int) {
