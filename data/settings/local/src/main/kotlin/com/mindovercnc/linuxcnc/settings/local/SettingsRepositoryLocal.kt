package com.mindovercnc.linuxcnc.settings.local
...
/** Local implementation for [SettingsRepository]. */
class SettingsRepositoryLocal(private val prefs: Preferences) : SettingsRepository {
