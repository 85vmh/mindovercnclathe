...
import com.mindovercnc.model.codegen.Operation
...
class DrillingOperation(
    ...
    override fun getStartComment(): List<String> {
        return mutableListOf<String>().apply { add("(---BEGIN---Drilling operation-----------)") }
    }

    override fun getEndComment(): List<String> {
        return mutableListOf<String>().apply { add("(----END----Drilling operation-----------)") }
    }

    override fun getOperationCode() =
