...
class SimpleCyclesUseCase(
    ...
    fun getCycleParameters(simpleCycle: SimpleCycle): SimpleCycleParameters {
        ...
        return when (simpleCycle) {
            SimpleCycle.Turning ->
                SimpleCycleParameters.TurningParameters(xEnd = 0.0, zEnd = 0.0, doc = 1.0)

            SimpleCycle.Boring ->
                SimpleCycleParameters.BoringParameters(xEnd = 0.0, zEnd = 0.0, doc = 1.0)

            SimpleCycle.Facing ->
                SimpleCycleParameters.FacingParameters(xEnd = 0.0, zEnd = 0.0, doc = 1.0)

            SimpleCycle.Threading ->
                SimpleCycleParameters.ThreadingParameters(
                    pitch = 1.0,
                    zEnd = 0.0,
                    majorDiameter = 0.0,
                    minorDiameter = 0.0,
            ...
            SimpleCycle.Drilling ->
                SimpleCycleParameters.DrillingParameters(
                    zEnd = 0.0,
                    retract = 0.0,
                    increment = 0.0,
                    rpm = 0.0,
            ...
            SimpleCycle.KeySlot ->
                SimpleCycleParameters.KeySlotParameters(
                    zEnd = 0.0,
                    xEnd = 0.0,
                    doc = 0.1,
                    feedPerMinute = 50.0
