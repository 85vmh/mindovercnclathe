...
class ManualPositionUseCase(private val cncStatusRepository: CncStatusRepository) {
    private data class PositionInfo(
        val position: Position,
        val xRelative: Boolean,
        val zRelative: Boolean
    )
    ...
    fun getPositionModel() =
        combine(getDisplayablePosition(), xRelativeState, zRelativeState) {
                displayablePos,
                xRelative,
                zRelative ->
                PositionInfo(displayablePos, xRelative, zRelative)
            }
