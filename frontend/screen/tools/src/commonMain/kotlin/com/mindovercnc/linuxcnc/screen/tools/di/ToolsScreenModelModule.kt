...
import com.mindovercnc.linuxcnc.screen.tools.root.tabs.cuttinginsert.add.feedsandspeeds.AddEditFeedsAndSpeedsScreenModel
...
val ToolsScreenModelModule =
    DI.Module("tools_screen_model") {
        ...
        bindProvider {
            AddEditFeedsAndSpeedsScreenModel(
                initialFeedsAndSpeeds = instanceOrNull(),
                toolsUseCase = instance()
            )
        }
    }
