...
import ui.screen.programs.programloaded.MachineLimits
...
data class VisualTurningState(
    ...
    val programRulers: ProgramRulers = ProgramRulers(
...
data class PathUiState(
    ...
    fun getInitialTranslate(viewportSize: IntSize) = pathActor.programData.getInitialTranslate(viewportSize)
}
...
data class ProgramRulers(
    ...
    val bottom: RulerActor = RulerActor(
    ...
    val left: RulerActor = RulerActor(
    ...
    val right: RulerActor = RulerActor(
