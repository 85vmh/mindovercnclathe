...
fun ThreadingTechnologyData() {
    ...
    val state = remember { ThreadTechnologyDataState(workOffsets.first(), threadType.first(), metricThreads.first()) }
    ...
    Column(
        ...
        Row(
            ...
            Text(
                modifier = Modifier.padding(start = 16.dp), text = "External"
            )
            RadioButton(selected = false, onClick = {

            })
            Text(
                modifier = Modifier.padding(start = 16.dp), text = "Internal"
            )
        }
        DropDownSetting(
            modifier = Modifier.weight(1f),
        ...
        InputSetting(
            modifier = Modifier.weight(1f),
            inputType = InputType.TOOL_NUMBER, value = "1"
        ) {}
        InputSetting(
            modifier = Modifier.weight(1f),
            inputType = InputType.RPM, value = "200"
        ) {}
        InputSetting(
            modifier = Modifier.weight(1f),
            inputType = InputType.TOOL_CLEARANCE, value = "1"
        ) {}
        InputSetting(
            modifier = Modifier.weight(1f),
            inputType = InputType.THREAD_STARTS, value = "1"
        ) {}
        InputSetting(
            modifier = Modifier.weight(1f),
            inputType = InputType.THREAD_PITCH, value = "1"
        ) {}
    }
