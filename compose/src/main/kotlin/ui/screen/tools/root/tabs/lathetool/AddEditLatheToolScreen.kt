...
class AddEditLatheToolScreen(
  ...
  override fun Content() {
    ...
    AddEditLatheToolContent(state, screenModel)
  }
}
...
private fun AddEditLatheToolContent(
  ...
  Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(16.dp)) {
    ...
    when (state.toolType) {
      ToolType.Turning,
      ToolType.Boring ->
        TurningBoringToolProperties(state, screenModel, state.toolType == ToolType.Boring)
      ToolType.Drilling,
  ...
  Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
    Column(modifier = Modifier.weight(1f), verticalArrangement = Arrangement.spacedBy(8.dp)) {
      ...
      OrientationAnglesCard(
        ...
        onBackAngleChanged = screenModel::setBackAngle,
        onFrontAngleChanged = screenModel::setFrontAngle,
