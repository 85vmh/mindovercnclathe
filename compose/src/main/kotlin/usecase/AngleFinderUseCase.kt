...
class AngleFinderUseCase(
    ...
    /**
     * Tre sa aleg pe care axa vreau sa traversez
     * In functie de asta setez un starting point pe X sau pe Z, dezactivez handwheel-ul celalalt
     * Ma deplasez pe axa selectata un amount.
     * Zic ca am terminat si cate ture a facut ceasul.
     * O sa fac un travel pe axa doar intre punctul initial si punctul final, cu spindle oprit
     * Travelul de verificare se face cu joystick la un feed prestabilit, o sa actioneze joystickul in functie de axa selectata
     * La final de cursa, intreb daca ceasul arata 0 si daca nu, intreb care e diferenta.
     * Recalculez si ii zic sa miste iar de joytstick ca sa retraverseze
     */
